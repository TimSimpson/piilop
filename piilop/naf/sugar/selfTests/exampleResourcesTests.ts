...
// Tests NAF itself.
export const grandParentsWithWrappedCreateAndDeletesTests = async () => {
...
export const grandParentsTests = async () => {
    const registry = createSelfTestRegistry();
...
export const parentsTests = async () => {
...
export const childrenTests = async () => {
